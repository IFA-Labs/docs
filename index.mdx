---
title: Introduction
description: "IFA Oracle Price Feed System - A decentralized oracle solution for stablecoin price data"
---
...
<Note>See script/DeployPriceFeed.sol for deployment implementation</Note>
...
<Note>The assets ID here are just for example purpose</Note>
